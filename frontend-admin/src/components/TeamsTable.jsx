                    ...
                    <tbody>
                        {filteredAndSortedTeams.map(team => (
                            <tr key={team.id} style={{ borderBottom: '1px solid #333', cursor: 'pointer', transition: 'background 0.2s' }}>
                                ...
                                <td data-label="Team Name" style={{ padding: '1rem' }}>{team.name}</td>
                                <td data-label="Level" style={{ padding: '1rem' }}>{team.level}</td>
                                <td data-label="Leader" style={{ padding: '1rem' }}>{team.leader_name || 'N/A'}</td>
                                <td data-label="Members" style={{ padding: '1rem' }}>{team.member_count}</td>
                                ...
                                <td data-label="Actions" style={{ padding: '1rem' }}>
                                    <button onClick={() => navigate(`/teams/${team.id}`)} className="btn-primary" style={{ padding: '0.3rem 0.8rem', fontSize: '0.9rem' }}>View Details</button>
                                </td>
                            </tr>
                        ))}
