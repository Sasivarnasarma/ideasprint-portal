        ...
        <aside className={`sidebar ${isOpen ? 'open' : ''}`} style={{
            ...
            <nav style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                <Link to="/dashboard" style={navItemStyle(isActive('/dashboard'))} onClick={onClose}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ width: '20px', height: '20px', marginRight: '12px' }}>
                ...
                <div style={{ marginTop: 'auto' }}>
                    <button onClick={logout} className="btn-secondary" style={{ width: '100%', borderColor: '#e74c3c', color: '#e74c3c' }}>
