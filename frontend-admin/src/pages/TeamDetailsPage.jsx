        ...
        <div className="auth-card" style={{ padding: '2.5rem' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '2rem' }}>
            <div
              ...
              style={{ width: '25%', height: '24px', marginBottom: '1rem' }}
            ></div>
  ...
  return (
    <div>
      ...
      >
        ...
        <button onClick={() => navigate('/teams')} className="btn-secondary" style={{ padding: '0.5rem 1rem' }}>
          &larr; Back to Teams
        </button>
      </div>
        ...
        >
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: '1.1rem', color: 'var(--color-accent)' }}>
              <a href={`mailto:${team.leader?.email}`} style={{ color: 'inherit', textDecoration: 'none' }}>
              ...
              <tbody>
                {team.leader && (
                  <tr
                    style={{
                      ...
                      backgroundColor: 'rgba(3, 199, 179, 0.05)',
                    }}
                  >
                    ...
                    <td data-label="Name" style={{ padding: '1rem', color: 'var(--color-accent)', fontWeight: 'bold' }}>
                      {team.leader.name}
                    </td>
                    <td data-label="Phone" style={{ padding: '1rem', color: 'var(--color-accent)' }}>
                      {team.leader.phone}
                    </td>
                    <td data-label="IM Number" style={{ padding: '1rem', color: 'var(--color-accent)' }}>
                      {team.leader.im_number}
                    </td>
                  </tr>
                )}
                {team.members.map((member) => (
                  <tr key={member.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                    ...
                    <td data-label="Name" style={{ padding: '1rem', color: 'white' }}>
                      {member.name}
                    </td>
                    <td data-label="Phone" style={{ padding: '1rem' }}>
                      {member.phone}
                    </td>
                    <td data-label="IM Number" style={{ padding: '1rem' }}>
                      {member.im_number}
                    </td>
                  </tr>
                ))}
