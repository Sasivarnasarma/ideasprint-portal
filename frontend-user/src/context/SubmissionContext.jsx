...
export const SubmissionProvider = ({ children }) => {
  ...
  const updateSubmissionData = (data) => {
    ...
    if (data.verificationToken !== undefined)
      localStorage.setItem('submissionVerificationToken', data.verificationToken);
    if (data.captchaSessionToken !== undefined)
      localStorage.setItem('submissionCaptchaSessionToken', data.captchaSessionToken);
