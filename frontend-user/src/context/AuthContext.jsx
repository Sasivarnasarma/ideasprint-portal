...
export const AuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        if (savedEmail || savedPendingEmail || savedName || savedPhone || savedImNumber || savedVerificationToken || savedCaptchaSession) {
            setRegistrationData({
                email: savedEmail || '',
    ...
    const clearRegistrationData = () => {
        ...
        setRegistrationData({ email: '', pendingEmail: '', name: '', phone: '', imNumber: '', verificationToken: '', captchaSessionToken: '' });
    };
