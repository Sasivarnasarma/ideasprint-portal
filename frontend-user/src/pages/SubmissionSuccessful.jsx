          ...
          <div className="stage-header" style={{ marginBottom: '1.5rem' }}>
            <div
              ...
              style={{
                ...
                color: 'var(--success)',
                boxShadow: '0 0 30px hsla(150, 80%, 40%, 0.4)',
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ fontSize: '1.1rem', fontWeight: '600', color: 'rgba(255,255,255,0.9)' }}
                >
                  Next Steps
                </span>
              </div>
              <p style={{ margin: '0.75rem 0', color: 'rgba(255,255,255,0.8)', fontSize: '1rem' }}>
                • We have safely stored your PDF and video link!
              </p>
              <p style={{ margin: '0.75rem 0', color: 'rgba(255,255,255,0.8)', fontSize: '1rem' }}>
                • A confirmation email has been sent.
              </p>
              <p style={{ margin: '0.75rem 0', color: 'rgba(255,255,255,0.8)', fontSize: '1rem' }}>
                • Stay tuned for further updates regarding the competition.
              </p>
            </div>
